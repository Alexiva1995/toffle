            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="mb-1">
                  ...
                  <select class="form-select rounded border-primary" id="status">
              ...
              <div class="col-md-4">
                <div class="mb-1">
                  ...
                  <select class="form-select rounded border-primary" id="role">
                    <option>Admin</option>
                    <option>User</option>
                    <option>Staff</option>
                  </select>
            ...
            <div class="row mt-1">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="mb-1">
                  ...
                  <select id="languages" class="form-select rounded border-primary">
