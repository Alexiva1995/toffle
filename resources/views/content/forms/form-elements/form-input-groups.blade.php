  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <div class="input-group input-group-merge rounded border-primary mb-2">
          ...
          <div class="input-group input-group-merge rounded border-primary form-password-toggle mb-2">
            <input
              type="password"
              class="form-control"
