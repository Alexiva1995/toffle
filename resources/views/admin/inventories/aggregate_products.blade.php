    ...
    <div class="col-12">
        <div class="m-0">
            ...
            <div class="card-body p-0 px-2">
                <form class="form form-vertical" action="{{ route('aggregate.product', $inventory->id) }}" id="form_aggregate_product" method="POST">
                    @csrf
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-md-6 mb-1">
                            <div class="mb-1">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="qty_package" class="form-control @error('qty_package') is-invalid @enderror" name="qty_package"
                        ...
                        <div class="col-12 col-md-6 mb-1">
                            <div class="mb-1">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="unit_package" class="form-control @error('unit_package') is-invalid @enderror"
