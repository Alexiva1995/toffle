                    ...
                    <div class="col-12">
                        <div class="mb-0">
                            ...
                            <div class="card-body px-2">
                                <form class="form form-vertical" action="{{ route('orders.store') }}"
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="input-group input-group-merge rounded border-primary">
                                                    ...
                                                    <input type="text" id="customer_name"
                                                        class="form-control requerid @error('customer_name') is-invalid @enderror"
                                                        name="customer_name" placeholder="Nombre" required />
                                                    @error('customer_name')
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="input-group input-group-merge rounded border-primary">
                                                    ...
                                                    <input type="number" id="table"
                                                        class="form-control requerid @error('table') is-invalid @enderror"
                                                        name="table" placeholder="Mesa" required />
                                                    @error('table')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-12 col-md-4 mb-1">
                                            <div class="mb-1">
                                                <label class="form-label" for="total_amount">Monto Total de lo
                                                    Pedido</label>
                                                <div class="input-group input-group-merge">
                                                    <span class="input-group-text"><i data-feather="archive"></i></span>
                                                    <input type="number" id="total_amount"
                                                        class="form-control requerid @error('total_amount') is-invalid @enderror"
                                                        name="total_amount" placeholder="" value="0.00" required />
                                                    @error('total_amount')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
